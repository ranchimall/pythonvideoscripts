...
# Seamless-loop, light-background version
# ============================================================
...
OUTPUT = "openai_navier_stokes_loop.webm"
...
LOGO_FILE = os.path.join(SCRIPT_DIR, "openai.png")
...
# -----------------------------
# COLORS (light background so nothing gets lost)
# -----------------------------
BG = "#eef1f5"                      # soft light gray-blue

PARTICLE_COLOR = (0.16, 0.24, 0.34)  # dark slate blue
FLOW_COLOR = (0.30, 0.42, 0.55)      # medium steel blue
CORE_COLOR = (0.09, 0.13, 0.22)      # near-navy, for contrast at the core
